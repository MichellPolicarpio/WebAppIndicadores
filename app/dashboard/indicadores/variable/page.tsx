...
import { ArrowLeft, Pencil, History, Trash2, X, ChevronLeft, ChevronRight, Calendar } from "lucide-react"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
                      ...
                      <td className="px-4 sm:px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Button
                            ...
                            className="bg-red-500 hover:bg-red-600 text-white h-9 w-9 p-0 rounded-lg shadow-sm hover:shadow-md transition-all"
                            title="Eliminar"
                          >
